...
class GlObject : public IBindable {
 public:
  ...
  Binder<GlObject> scope_bind() const {
    return {this};
  }
...
class GlTextureObject : public GlObject {
 public:
  ...
  Binder<GlTextureObject> scope_bind_texture() const {
    return {this};
  }
...
class GlBufferObject : public GlObject {
 public:
  ...
  inline Binder<GlBufferObject> scope_bind_buffer() const {
    return {this};
  }
